...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary:
    "bg-[var(--muted)] text-[var(--foreground)] border border-[var(--border)] hover:border-[var(--border-strong)]",
  outline:
    "border-2 border-[var(--border-strong)] text-[var(--foreground)] hover:bg-[var(--muted)]",
  ghost:
